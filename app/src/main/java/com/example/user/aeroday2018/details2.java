...
public class details2 extends AppCompatActivity {
    ...
    String epreuve3 = "\nTraverser l'atmosphére terrestre :\n" ;
    String epreuve4 = "\nse stabiliser au-dessus de la station d'espace internationale :\n" ;
    String epreuve5 = "\nTourner autour de la planéte VENUS:\n" ;
    String epreuve6 = "\nEffectuer un mouvement de ZIGZAG entre VENUS,MARS et JUPITER:\n" ;
    String epreuve7 = "\nTraverser le trou noir :\n" ;
    String epreuve8 = "\nTourner autour des anneaux de la planéte SATURNE :\n" ;
    String epreuve9 = "\nAtterrir sur la zone d'arrivée:la planéte SATURNE :\n" ;
    String epreuve10 = "\nRemarques :\n" ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (details[5]) cont2+=("échec du premier essai du vol  : -3 points"+Newligne) ;
